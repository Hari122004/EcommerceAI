...
st.set_page_config(
    page_title="AI Assistant | SmartCart AI",
    page_icon="🤖",
...
# ── Page header ───────────────────────────────────────────────────────────────
render_topbar("AI Assistant", "Chat with SmartCart AI's intelligent recommendation engine")
...
engine_note = "Grok AI + SmartCart AI engines" if grok_available else "SmartCart AI engines (add GROK_API_KEY for Grok)"
st.markdown(f"""
