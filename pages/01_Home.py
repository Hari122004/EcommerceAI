...
st.set_page_config(page_title="Home | SmartCart AI", page_icon="💡", layout="wide", initial_sidebar_state="expanded")
check_login()
...
<div style="text-align:center;padding:24px 0 8px;
  ...
  <p style="font-size:12px;color:{p['text_muted']};margin:0;">
    SmartCart AI v2.0 &middot; Built with care by Team SmartCart AI &middot; Sourcesys Technologies
  </p>
</div>""", unsafe_allow_html=True)
