...
st.set_page_config(page_title="About | SmartCart AI", page_icon="💡", layout="wide", initial_sidebar_state="expanded")
check_login()
...
render_topbar("About SmartCart AI", "Discover what powers your AI recommendations")
...
<div style="background-color:{p['card_bg']};border:1px solid {p['border']};border-radius:20px;
  ...
  <p style="font-size:15px;color:{p['text_secondary']};line-height:1.8;margin:0">
    <strong style="color:{p['text_primary']}">SmartCart AI</strong> is an intelligent, AI-powered product recommendation platform
...
<div style="background:{p['card_bg']};border:1px solid {p['border']};border-radius:20px;
  ...
  <div style="display:inline-flex;align-items:center;gap:8px;
    ...
    <a href="mailto:smartcart-ai.support@gmail.com"
       style="font-size:14px;font-weight:600;color:{p['accent']};text-decoration:none;">
      smartcart-ai.support@gmail.com
    </a>
  </div>
</div>""", unsafe_allow_html=True)
