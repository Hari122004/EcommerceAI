...
st.set_page_config(page_title="Trending | SmartCart AI", page_icon="💡", layout="wide", initial_sidebar_state="expanded")
check_login()
...
<div class="trending-ticker-wrapper">
  <span class="trending-ticker">
    ...
    Updated every session · Powered by SmartCart AI ·
...
# ── Top Bar ───────────────────────────────────────────────────────────────────
render_topbar("What's Hot Right Now", "Discover what the SmartCart AI community is loving")
