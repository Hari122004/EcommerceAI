...
st.set_page_config(page_title="My Profile | SmartCart AI", page_icon="💡", layout="wide", initial_sidebar_state="expanded")
check_login()
...
">
  ...
  <div style="position:relative;z-index:1;flex:1;min-width:0;">
    ...
    <p style="font-size:12px;color:rgba(255,255,255,0.8);margin:0 0 8px;
      ...
      @{username} &nbsp;·&nbsp; {user_email or "guest@smartcart-ai.com"}
    </p>
...
def _delete_account_dialog(uid: str, email: str):
    ...
    st.markdown(f"All data for **{email}** will be erased from SmartCart AI.")
