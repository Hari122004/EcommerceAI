...
html,body{background:#D7EEFF!important}
.stApp,[data-testid="stAppViewContainer"],[data-testid="stAppViewContainer"]>.main,[data-testid="stMainBlockContainer"],.main .block-container{background:#D7EEFF!important}
/* ── Base reset ── */
*,*::before,*::after{box-sizing:border-box}
html,body,[data-testid="stAppViewContainer"],[data-testid="stAppViewContainer"]>.main{
  font-family:'Inter',-apple-system,BlinkMacSystemFont,sans-serif!important}
[data-testid="stAppViewContainer"]>.main{
  background:linear-gradient(135deg,#DFF5FF 0%,#E8F8FF 50%,#F2FBFF 100%)!important}
...
(function() {
  ...
  if (h && h.includes('type=signup')) {
    window.location.href = window.location.origin + window.location.pathname + '?confirmed=1';
                ...
                full_name = st.text_input("Full Name", placeholder="Your full name", key="su_name").strip()
                email = st.text_input("Email address", placeholder="you@example.com", key="su_email").strip()
